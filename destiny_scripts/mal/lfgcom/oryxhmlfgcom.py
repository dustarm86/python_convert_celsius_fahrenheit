...
select_activity = browser.find_element_by_xpath(".//*[@id='selectActivity']/optgroup[10]/option[6]").click()

# write description for activity chosen
description = browser.find_element_by_xpath(".//*[@id='textComment']")
description.send_keys("ORYX CP: Need 2 +305's with ToM (No Knight Strat). Message and Friend Request me on PSN to Join! PSN = Conscious_Acts")
