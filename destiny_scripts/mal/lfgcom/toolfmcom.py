...
select_activity = browser.find_element_by_xpath(".//*[@id='selectActivity']/optgroup[8]/option[2]").click()

# write description for activity chosen
description = browser.find_element_by_xpath(".//*[@id='textComment']")
description.send_keys("LFM +2.0KD player looking to help others get to the Lighthouse! Message and Friend Request me on PSN to Join! PSN = Conscious_Acts")
